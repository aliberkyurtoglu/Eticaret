			...
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Twitter'da Biz</div>
					</div>
					<ul class="tweets">
						<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita, assumenda. <b>#sanalsepetim </b><a href="#">http://t.co/LbLwldb6 </a>
						<span>32 dakika önce</span></li>
						<li class="lastone"><b>#sanalsepetim</b> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis molestias architecto expedita?<a href="#">http://t.co/LbLwldb6 </a>
						<span>2 saat önce</span></li>
					</ul>
					<div class="clearfix"></div>
					<a href="#" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Twitter'da Takip et</div></a>
				</div><!--footer twitter widget-->
				<div class="col-md-4"><!--footer newsletter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Haberdar Ol</div>
					</div>
					<div class="newsletter">
						...
						<form role="form">
							<div class="form-group">
								...
								<input type="email" class="form-control newstler-input" id="exampleInputEmail1" placeholder="E-mailinizi girin">
								<button class="btn btn-default btn-red btn-sm">Haberdar Et</button>
							</div>
						</form>
					</div>
				...
				<div class="col-md-4"><!--footer contact widget-->
					<div class="title-widget-bg">
						<div class="title-widget-cursive">iletişim</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;Tüm Hakları Saklıdır <a href="http://<?php echo $ayarcek['ayar_facebook']; ?>"><?php echo $ayarcek['ayar_yazar']; ?></a></div>
